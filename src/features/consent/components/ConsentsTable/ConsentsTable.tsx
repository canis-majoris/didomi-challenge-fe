...
import { useConsentTypesQuery } from '../../hooks';
        ...
        {isLoading ? (
          ...
          <Table
            ...
            sx={{
              ...
              '& th, & td': { border: 1, borderColor: 'grey.300' },
              width: '100%',
            }}
          >
            <TableHead>
                  ...
                  <TableCell>
                    <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1 }}>
                      {isConsentTypesLoading ? (
                        ...
                        getConsentTypeLabels(c.consentTypes).map((consentLabel) => (
                          <Chip
                            key={consentLabel}
                            size="small"
                            label={consentLabel}
